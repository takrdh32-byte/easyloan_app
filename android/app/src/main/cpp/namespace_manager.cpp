...
int NamespaceManager::cloneProcess(const NamespaceConfig& config,
    ...
    // Parent को स्टैक क्लीन करने के लिए waitpid नहीं करना चाहिए,
    // क्योंकि हम चाइल्ड को चलते रहने देना चाहते हैं।
    // इसलिए हम यहाँ पर कोई wait नहीं करते — clone manager बाद में सँभालेगा।

    // स्टैक को delete नहीं कर सकते, क्योंकि चाइल्ड उसे यूज़ कर रहा है।
    // इसे मैनेज करने के लिए हम बाद में एक क्लीनर जोड़ेंगे।
    return childPid;
}
...
void NamespaceManager::terminateClone(int pid) {
    ...
    if (kill(pid, SIGKILL) == 0) {
        // child को मारने के बाद zombie बनने से रोकने के लिए waitpid
